...
export const EpisodeList: React.FC<EpisodeListProps> = ({
  ...
  return (
    <div 
      ref={parentRef} 
      className="h-full flex flex-col min-h-0 bg-white" // 更浅的背景色
    >
      {/* 标题区域 */}
      <div className="flex-none px-4 py-2.5 text-sm font-medium sticky top-0 z-10 text-gray-700 bg-gray-50/60 backdrop-blur-sm border-b border-gray-100 app-drag-region">
